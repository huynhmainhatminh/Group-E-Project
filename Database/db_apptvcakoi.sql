CREATE DATABASE  IF NOT EXISTS `apptvcakoi` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `apptvcakoi`;
...
CREATE TABLE `product` (
  ...
  `name_product` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  ...
  `color_product` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `destiny_product` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
INSERT INTO `product` VALUES (1,'Hồ cá koi mini đẹp ','Với nhiều căn nhà có diện tích khuôn viên hạn chế, gia chủ thường cân nhắc tận dụng diện tích trong nhà để thiết kế hồ cá koi mini. ','tandat2882',NULL,NULL,NULL,1),(2,'Hồ cá koi đơn giản chuẩn phong thủy','Mẫu thiết kế hồ cá koi đơn giản thường được đặt ở hiên trước nhà vì đây là vị trí đắc địa: vừa đáp ứng các yếu tố thẩm mỹ, vừa tạo thế “tiền thủy” mang tài lộc, vận may đến gia đình chủ nhà.','duymanh283',NULL,NULL,NULL,1),(3,'Hồ cá koi biệt thự đẹp','Xu hướng thi công hồ cá koi trong sân vườn biệt thự cao cấp hiện đang được nhiều người ưa chuộng. Chỉ cần ngồi trong phòng khách ngắm nhìn đàn cá bơi lội, gia chủ cũng cảm nhận được sự bình yên và an tĩnh.','thienkim2881',NULL,NULL,'',1),(4,'Hikari Hi Utsuri',NULL,'tandat2882','Đen, Đỏ','Thổ, Mộc','~/KOI/hikari-hi-utsuri.jpg',2),(5,'Ki Utsuri',NULL,'tandat2882','Đen, Vàng','Kim, Thủy','~/KOI/ki-utsuri.jpg',2),(6,'Hikari Kin Showa',NULL,'tandat2882','Đen, Đỏ, Trắng','Kim, Mộc, Thổ, Thủy','~/KOI/hikari-kin-showa.jpg',2),(7,'Shiro Utsuri',NULL,'tandat2882','Đen, Trắng','Kim, Mộc, Thổ, Thủy','~/KOI/shiro-utsuri.jpg',2),(8,'Tancho Kohaku',NULL,'tandat2882','Trắng, Đỏ','Kim, Hỏa','~/KOI/tancho-kohaku.jpg',2),(9,'Tancho – Sanke',NULL,'tandat2882','Trắng, Đỏ, Đen','Kim, Hỏa, Mộc, Thổ, Thủy','~/KOI/tancho-sanke.jpg',2),(10,'Koi Tancho – Showa',NULL,'tandat2882','Trắng, Đỏ, Đen','Kim, Hỏa, Mộc, Thổ, Thủy','~/KOI/tancho–showa.jpg',2),(11,'Mameshibori Goshiki',NULL,'tandat2882','Đỏ, Trắng, Xanh','Kim, Hỏa, Thủy','~/KOI/mameshibori-goshiki.jpg',2),(12,'KinDai Goshiki',NULL,'tandat2882','Trắng, Đen, Đỏ','Kim, Hỏa, Mộc, Thổ, Thủy','~/KOI/kindai-goshiki.jpg',2),(13,'Kuro Goshiki',NULL,'tandat2882','Đen, Đỏ','Hỏa, Mộc, Thổ, Thủy','~/KOI/kuro-goshiki.jpg',2),(14,'Nezu Goshiki',NULL,'tandat2882','Đỏ, Trắng','Hỏa, Kim','~/KOI/nezu-goshiki.jpg',2),(15,'Ginrin Goshiki',NULL,'tandat2882','Đen, Đỏ','Hỏa, Mộc, Thổ, Thủy','~/KOI/ginrin-goshiki.jpg',2);
...
CREATE TABLE `product_user` (
  ...
  `img_product` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `idproduct_type` int DEFAULT NULL,
...
CREATE TABLE `ql_parameter` (
  ...
  `color_fit` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
  `color_not_fit` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
...
INSERT INTO `ql_parameter` VALUES (1,'Mộc','3 hoặc 9','Đông Nam','Đen, Xanh Dương','Xanh Lá Cây','Trắng, Bạc'),(2,'Thủy','1 hoặc 6','Bắc','Trắng, Bạc','Đen, Xanh Dương','Vàng, Nâu'),(3,'Hỏa','2 hoặc 7','Bắc','Xanh Lá Cây','Đỏ, Hồng','Đen, Xanh Dương'),(4,'Thổ','5 hoặc 10','Đông Bắc hoặc Tây Nam','Đỏ, Hồng','Vàng, Nâu','Xanh Lá Cây'),(5,'Kim','4 hoặc 9','Tây hoặc Tây Nam','Vàng, Nâu','Trắng, Xám, Bạc','Đỏ, Hồng');
...
CREATE TABLE `ql_user` (
  ...
  `name_user` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `username` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `pass_user` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  ...
  `facebook` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin,
...
INSERT INTO `ql_user` VALUES (1,'Huỳnh Tấn Đạt','tandat2882','dat123@@',NULL,NULL,NULL,'user'),(2,'Đỗ Duy Mạnh','duymanh283','manh992@#@',NULL,NULL,NULL,'user'),(3,'Thiên Vũ Kim','thienkim2881','kimvu00233@',NULL,NULL,NULL,'user'),(4,'Hoàng Vũ Anh','vuanhne992','thanhnam28882',NULL,NULL,NULL,'user'),(5,'Huỳnh Mai Nhật Minh','minh28052005','minh28052005@@',NULL,NULL,NULL,'admin'),(11,'Nguyễn Vũ','hello99002','199000222',NULL,NULL,NULL,'user'),(14,'Hoàng Vinh','binhhoang0022','minh008922',NULL,NULL,NULL,'user'),(15,'Hoàng Tú','ievihiehfihefiheif','2345432',NULL,NULL,NULL,'user'),(16,'Đỗ Vinh','2e34t53r','3r4565t43r',NULL,NULL,NULL,'user'),(17,'Thanh Vũ','345ytr34t5','345ytre',NULL,NULL,NULL,'user');
...
-- Dump completed on 2024-11-02 20:32:51
